...
function auth() {
    return __awaiter(this, void 0, void 0, function () {
        var browser, page, cookies, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, page.waitForSelector('a[title=Сообщения]')];
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4:
                ...
                case 5:
                    cookies = _a.sent();
                    return [4 /*yield*/, fs.writeFile('./cookies.json', JSON.stringify(cookies, null, 2))];
                case 6:
                    _a.sent();
